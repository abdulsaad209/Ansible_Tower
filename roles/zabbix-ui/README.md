...
This is **ZABBIX-UI** role designed to run only for **Zabbix v7.4.x** 


# Requirements
------------

You can use below docker image as Execution Environment (EE) in Ansible AWX to run this role. Or you can create your own image by following below mentioned steps.

**Docker Image:** saadzahid/awx-ee-zabbix:v1
...
- name: Deploy Zabbix Agent2
  ...
  vars:
    ...
    zabbix_url: "https://zabbix.ms.com/zabbix"
...
**Here**
10.0.0.37 = Zabbix_Proxy IP
10.0.0.36 = Zabbix Server IP

**You can set IP value of your server and proxy**
